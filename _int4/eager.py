...
"""Eager (pure-torch) ConvRot W4A4 kernels.

Vendored from comfy-kitchen (comfy_kitchen/backends/eager/convrot_w4a4.py) with
the only change being the codec import repointed to the local ._codec module so
this node has no comfy_kitchen dependency. See NOTICE for attribution.
"""
...
from ._codec import _INT4_GROUP_SIZE, _INT4_MAX, _pack_int4_row_major, _unpack_int4_row_major
